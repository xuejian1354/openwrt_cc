...
static const gchar introspection_xml[] =
	"<node>"
	"  <interface name='com.upointech.demoapp1.management'>"
	"    <method name='Stop'>"
				...
				gpointer         user_data)
{
	...
	registration_id = g_dbus_connection_register_object(connection,
					  "/com/upointech/demoapp1/Config/global/global",
	...
	registration_id = g_dbus_connection_register_object(connection,
					  "/com/upointech/demoapp1/Config/section/1",
					  introspection_config_data->interfaces[0],
	...
	g_assert(registration_id > 0);
	registration_id = g_dbus_connection_register_object(connection,
					  "/com/upointech/demoapp1/Config/section/2",
					  introspection_config_data->interfaces[0],
