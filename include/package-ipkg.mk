...
)$$(call addfield,DbusVersion,$(PKG_DBUS_VERSION)
...
)$$(call addfield,Capabilities,$(PKG_CAPABILITIES)
)$$(call addfield,SelfInterface,$(PKG_SELF_INTERFACE)
)$$(call addfield,UseInterface,$(PKG_USE_INTERFACE)
)$$(call addfield,UseGwSystemPath,$(PKG_USE_GWSYS_PATH)
)$$(call addfield,SubscribeEvent,$(PKG_SUBSCRIBE_EVENT)
)$$(call addfield,SelfDataUds,$(PKG_SELF_UDS)
)$$(call addfield,UseDataUds,$(PKG_USE_UDS)
)$$(call addfield,Vendor,$(PKG_VENDOR)
)$$(call addfield,IconPath,$(PKG_ICON_PATH)
)$$(call addfield,KernelModules,$(PKG_KERNEL_MODULES)
)$$(call addfield,ProcRw,$(PKG_PROC_RW)
)$$(call addfield,SameNtwkNS,$(PKG_SAME_NTWK_NS)
)$$(call addfield,NeedRoot,$(PKG_NEED_ROOT)
)$$(call addfield,NeedGWVendor,$(PKG_NEED_GWVENDOR)
)$$(call addfield,AccessStorage,$(PKG_ACCESS_STORAGE)
)$$(call addfield,CpuShare,$(PKG_CPU_SHARE)
)$$(call addfield,MemoryLimit,$(PKG_MEMORY_LIMIT)
)$$(call addfield,BlkioWeight,$(PKG_BLKIO_WEIGHT)
)$$(call addfield,MaxStorageSize,$(PKG_MAX_STORAGE_SIZE)
)$$(call addfield,PluginPriority,$(PKG_PLUGIN_PRIORITY)
)$$(call addfield,TcpPorts,$(PKG_TCP_PORTS)
)$$(call addfield,UdpPorts,$(PKG_UDP_PORTS)
)$$(call addfield,MaxProcNum,$(PKG_MAX_PROC_NUM)
)$$(call addfield,MaxFileNum,$(PKG_MAX_FILE_NUM)
